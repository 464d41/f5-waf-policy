...
class Violation {
    constructor(violation) {
        ...
        this.title = violation.title || defaults.title;
        this.description = violation.description || defaults.description;
        this.alarm = violation.alarm || defaults.alarm;
        this.block = violation.block || defaults.block;
        this.learn = violation.learn || defaults.learn;
    }
